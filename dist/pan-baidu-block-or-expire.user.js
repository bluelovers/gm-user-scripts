...
e.exports.id = "pan-baidu-block-or-expire", e.exports.version = "", e.exports.name = "pan-baidu-block-or-expire", 
e.exports.name_en = "pan-baidu-block-or-expire", e.exports.name_ja = "pan-baidu-block-or-expire", 
e.exports.desc = "輔助判斷百度盤是封鎖還是過期", e.exports.desc_en = "輔助判斷百度盤是封鎖還是過期", e.exports.desc_ja = "輔助判斷百度盤是封鎖還是過期", 
e.exports.namespace = "", e.exports.author = "", e.exports.icon = "", e.exports.list = [ "site/pan.baidu" ], 
e.exports.list_disable = [], e.exports._lib = (() => {
n(5);
}), e.exports.metadata = {}, e.exports.metadata.include = [ "http*://pan.baidu.com/s/*", "http*://pan.baidu.com/error/*", "http*://pan.baidu.com/wap/error*" ], 
e.exports.metadata.match = [ "*://pan.baidu.com/wap/error" ], e.exports.metadata.exclude = [], 
e.exports.metadata.grant = [], e.exports.list_script = [], e.exports.current = [], 
...
const o = n(6), i = n(2);
e.exports.id = i.default.id, e.exports.name = e.exports.id, o.run(e.exports.id, e.exports, r, function(e, t, n, r, i, a) {
o.init(e, t, n, r, i, a);
});
...
let o = {
metadata: {
include: [ "http*://pan.baidu.com/s/*", "http*://pan.baidu.com/error/*", "http*://pan.baidu.com/wap/error*" ],
match: [ "https://pan.baidu.com/wap/error", "http://pan.baidu.com/wap/error" ],
nomatch: [],
exclude: [],
grant: []
},
...
if (e.path.match(/wap\/error(?=[\/\?]|$)/)) {
let t;
e.query.match(/err_num=1/) ? r("#pageMain .share-error.error-box").prepend("<div>\n<font color=red>此分享連結可能已經過期或刪除</font><br>\n<font color=red>請通知分享者補檔或嘗試其他分流連結</font><br>\n</div>") : e.query.match(/err_num=3/) && r("#pageMain .share-error.error-box").prepend("<div>\n<font color=blue>1. 你的 IP 可能屬於被和諧區域</font><br>\n<font color=blue>請嘗試使用 VPN / Proxy</font><br>\n<font color=red>2. 此分享者所屬的 IP 可能被和諧</font><br>\n<font color=red>請通知更換其他網盤再進行分享</font><br>\n</div>");
} else e.path.match(/\/error(?=[\/\?]|$)/) && !/文件已取消/.test(document.title) ? r(".module-error .reason, #pageMain .share-error.error-box").prepend("<div>\n<font color=blue>1. 你的 IP 可能屬於被和諧區域</font><br>\n<font color=blue>請嘗試使用 VPN / Proxy</font><br>\n<font color=red>2. 此分享者所屬的 IP 可能被和諧</font><br>\n<font color=red>請通知更換其他網盤再進行分享</font><br>\n</div>") : e.path.match(/\/s\/\w+/) && r("#mainContent #share_nofound_des .error-img").after("<div>\n<font color=blue>1. 百度盤可能出錯</font><br>\n<font color=blue>請嘗試重新整理頁面</font><br>\n<font color=red>2. 此分享連結可能已經過期或刪除</font><br>\n<font color=red>請通知分享者補檔或嘗試其他分流連結</font><br>\n</div>");
},
adblock(e = t._url_obj) {},
clearly(e = t._url_obj, n = null) {
let o = r(n);
return o = o.add([ "#pageBottom, #novel_header, #footer" ].join());
}
};
e.exports = o;
...
var n = t || [];
return null != e && (M(Object(e)) ? C.merge(n, "string" == typeof e ? [ e ] : e) : f.call(n, e)), 
n;
},
...
var E = function(e) {
var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, T = 0, j = 0, _ = ae(), C = ae(), A = ae(), M = function(e, t) {
return e === t && (f = !0), 0;
}, E = {}.hasOwnProperty, k = [], S = k.pop, N = k.push, D = k.push, $ = k.slice, q = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", L = "[\\x20\\t\\r\\n\\f]", G = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", P = "\\[" + L + "*(" + G + ")(?:" + L + "*([*^$|!~]?=)" + L + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + G + "))|)" + L + "*\\]", R = ":(" + G + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + P + ")*)|.*)\\)|)", H = new RegExp(L + "+", "g"), I = new RegExp("^" + L + "+|((?:^|[^\\\\])(?:\\\\.)*)" + L + "+$", "g"), W = new RegExp("^" + L + "*," + L + "*"), B = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"), F = new RegExp("=" + L + "*([^\\]'\"]*?)" + L + "*\\]", "g"), U = new RegExp(R), Q = new RegExp("^" + G + "$"), z = {
ID: new RegExp("^#(" + G + ")"),
CLASS: new RegExp("^\\.(" + G + ")"),
TAG: new RegExp("^(" + G + "|[*])"),
ATTR: new RegExp("^" + P),
...
for (c = y.length; c--; ) (f = y[c]) && (l = o ? q(i, f) : p[c]) > -1 && (i[l] = !(a[l] = f));
}
...
var f, h, m, y = 0, v = "0", b = i && [], x = [], w = l, j = i || o && r.find.TAG("*", c), _ = T += null == w ? 1 : Math.random() || .1, C = j.length;
for (c && (l = a === d || a || c); v !== C && null != (f = j[v]); v++) {
if (o && f) {
...
this.length > 1 && (P[e] || C.uniqueSort(o), G.test(e) && o.reverse()), this.pushStack(o);
};
});
var H = /[^\x20\t\r\n\f]+/g;
function I(e) {
...
var _e = s.documentElement, Ce = /^key/, Ae = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Me = /^([^.]*)(?:\.(.+)|)/;
function Ee() {
return !0;
}
function ke() {
...
if (m) for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(_e, o), 
n.guid || (n.guid = C.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
return void 0 !== C && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0;
}), l = (t = (t || "").match(H) || [ "" ]).length; l--; ) d = g = (s = Me.exec(t[l]) || [])[1], 
...
if (m && (u = m.events)) {
for (l = (t = (t || "").match(H) || [ "" ]).length; l--; ) if (d = g = (s = Me.exec(t[l]) || [])[1], 
h = (s[2] || "").split(".").sort(), d) {
...
ve.test(u.type || "") && !te.access(u, "globalEval") && C.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : T(u.textContent.replace(Oe, ""), l, u));
}
return e;
}
function We(e, t, n) {
...
if (t) if (n) for (i = i || xe(e), a = a || xe(s), r = 0, o = i.length; r < o; r++) Re(i[r], a[r]); else Re(e, s);
...
_e.appendChild(l).appendChild(c);
...
if ((t = jt(e)).length) for (;n = this[u++]; ) if (o = Tt(n), r = 1 === n.nodeType && " " + wt(o) + " ") {
...
var t, o, i, a;
if (r) for (o = 0, i = C(this), a = jt(e); t = a[o++]; ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = Tt(this)) && te.set(this, "__className__", t), 
...
var Mt = n.location, Et = Date.now(), kt = /\?/;
...
var Ot = /%20/g, Lt = /#.*$/, Gt = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Rt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ht = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), Ut = s.createElement("a");
function Qt(e) {
return function(t, n) {
...
var r, o, i, a, u, l, c, f, p, d, h = C.ajaxSetup({}, t), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? C(g) : C.event, y = C.Deferred(), v = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", j = {
readyState: 0,
getResponseHeader: function(e) {
var t;
if (c) {
if (!a) for (a = {}; t = Pt.exec(i); ) a[t[1].toLowerCase()] = t[2];
t = a[e.toLowerCase()];
}
...
if (y.promise(j), h.url = ((e || h.url || Mt.href) + "").replace(It, Mt.protocol + "//"), 
...
delete h.data), !1 === h.cache && (o = o.replace(Gt, "$1"), d = (kt.test(o) ? "&" : "?") + "_=" + Et++ + d), 
...
if (T = "abort", v.add(h.complete), j.done(h.success), j.fail(h.error), r = zt(Bt, h, t, j)) {
...
l ? (h.ifModified && ((w = j.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w), 
(w = j.getResponseHeader("etag")) && (C.etag[o] = w)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = x.state, 
p = x.data, l = !(d = x.error))) : (d = T, !e && T || (T = "error", e < 0 && (e = 0))), 
j.status = e, j.statusText = (t || T) + "", l ? y.resolveWith(g, [ p, T, j ]) : y.rejectWith(g, [ j, T, d ]), 
j.statusCode(b), b = void 0, f && m.trigger(l ? "ajaxSuccess" : "ajaxError", [ j, h, l ? p : d ]), 
v.fireWith(g, [ j, T ]), f && (m.trigger("ajaxComplete", [ j, h ]), --C.active || C.event.trigger("ajaxStop")));
}
return j;
},
...
for (var x = 0, T = e.length, j; x < T && (j = e.charAt(x)); x++) if (this.debug("%s\t%s %s %j", e, x, r, j), 
...
b(), i = !0;
var _ = c.pop();
r += _.close, "!" === _.type && p.push(_), _.reEnd = r.length;
continue;
...
var M = this.parse(A, w);
r = r.substr(0, g) + "\\[" + M[0] + "\\]", i = i || M[1], h = !1;
continue;
}
}
i = !0, h = !1, r += j;
...
for (h && (A = e.substr(m + 1), M = this.parse(A, w), r = r.substr(0, g) + "\\[" + M[0], 
i = i || M[1]), _ = c.pop(); _; _ = c.pop()) {
var E = r.slice(_.reStart + _.open.length);
this.debug("setting tail", r, _), E = E.replace(/((?:\\{2}){0,64})(\\?)\|/g, function(e, t, n) {
return n || (n = "\\"), t + t + n + "|";
}), this.debug("tail=%j\n   %s", E, E, _, r);
var k = "*" === _.type ? u : "?" === _.type ? s : "\\" + _.type;
i = !0, r = r.slice(0, _.reStart) + k + "\\(" + E;
}
b(), l && (r += "\\\\");
var S = !1;
switch (r.charAt(0)) {
...
}, y.prototype.match = _, y.prototype.matchOne = function(e, t, n) {
...
if (l) {
var T = c(p[0]), j = c(p[1]), _ = Math.max(p[0].length, p[1].length), C = 3 == p.length ? Math.abs(c(p[2])) : 1, A = v, M;
j < T && (C *= -1, A = b);
var E = p.some(y);
w = [];
for (var k = T; A(k, j); k += C) {
var S;
