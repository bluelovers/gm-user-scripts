...
var n = t || [];
return null != e && (A(Object(e)) ? k.merge(n, "string" == typeof e ? [ e ] : e) : f.call(n, e)), 
n;
},
...
var M = function(e) {
var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, T = 0, j = ue(), k = ue(), C = ue(), A = ue(), M = function(e, t) {
return e === t && (f = !0), 0;
}, E = {}.hasOwnProperty, S = [], N = S.pop, D = S.push, $ = S.push, q = S.slice, O = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", G = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", P = "\\[" + G + "*(" + R + ")(?:" + G + "*([*^$|!~]?=)" + G + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + G + "*\\]", H = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + P + ")*)|.*)\\)|)", I = new RegExp(G + "+", "g"), W = new RegExp("^" + G + "+|((?:^|[^\\\\])(?:\\\\.)*)" + G + "+$", "g"), B = new RegExp("^" + G + "*," + G + "*"), F = new RegExp("^" + G + "*([>+~]|" + G + ")" + G + "*"), z = new RegExp(G + "|>"), U = new RegExp(H), Q = new RegExp("^" + R + "$"), V = {
ID: new RegExp("^#(" + R + ")"),
CLASS: new RegExp("^\\.(" + R + ")"),
TAG: new RegExp("^(" + R + "|[*])"),
ATTR: new RegExp("^" + P),
...
var n, o, i, s, u, c, f = [], h = [], m = C[e + " "];
if (!m) {
for (t || (t = a(e)), n = t.length; n--; ) (m = je(t[n]))[x] ? f.push(m) : h.push(m);
(m = C(e, (o = h, s = 0 < (i = f).length, u = 0 < o.length, c = function(e, t, n, a, c) {
var f, h, m, y = 0, v = "0", b = e && [], x = [], w = l, T = e || u && r.find.TAG("*", c), j = _ += null == w ? 1 : Math.random() || .1, k = T.length;
for (c && (l = t === d || t || c); v !== k && null != (f = T[v]); v++) {
if (u && f) {
...
k.find = M, k.expr = M.selectors, k.expr[":"] = k.expr.pseudos, k.uniqueSort = k.unique = M.uniqueSort, 
k.text = M.getText, k.isXMLDoc = M.isXML, k.contains = M.contains, k.escapeSelector = M.escape;
...
}), k.ready.then = z.then, "complete" === s.readyState || "loading" !== s.readyState && !s.documentElement.doScroll ? n.setTimeout(k.ready) : (s.addEventListener("DOMContentLoaded", U), 
...
for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === T(i)) k.merge(p, i.nodeType ? [ i ] : i); else if (je.test(i)) {
...
var Ce = /^key/, Ae = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Me = /^([^.]*)(?:\.(.+)|)/;
function Ee() {
return !0;
}
function Se() {
...
if (m) for (n.handler && (n = (i = n).handler, o = i.selector), o && k.find.matchesSelector(ue, o), 
...
i || r)) {
for (s = (a = k.map(xe(o, "script"), Pe)).length; f < p; f++) u = o, f !== d && (u = k.clone(u, !0, !0), 
...
return (n = n || ze(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || le(e) || (a = k.style(e, t)), 
...
function it(e, t, n) {
var r = ze(e), o = (!v.boxSizingReliable() || n) && "border-box" === k.css(e, "boxSizing", !1, r), i = o, a = Qe(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
if (Fe.test(a)) {
if (!n) return a;
a = "auto";
}
...
set: function(e, n, r) {
var o, i = ze(e), a = !v.scrollboxSize() && "absolute" === i.position, s = (a || r) && "border-box" === k.css(e, "boxSizing", !1, i), u = r ? ot(e, t, r, s, i) : 0;
...
r;
return k.map(c, mt, l), b(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), 
...
null == (l = m && m.display) && (l = ee.get(e, "display")), "none" === (c = k.css(e, "display")) && (l ? c = l : (ge([ e ], !0), 
...
for (r in g || ge([ e ]), ee.remove(e, "fxshow"), d) k.style(e, r, d[r]);
...
var t, o, i, a;
if (r) for (o = 0, i = k(this), a = jt(e); t = a[o++]; ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = Tt(this)) && ee.set(this, "__className__", t), 
...
if (a = d = u = r = r || s, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(m + k.event.triggered) && (-1 < m.indexOf(".") && (m = (y = m.split(".")).shift(), 
...
k.event.triggered = m, e.isPropagationStopped() && d.addEventListener(m, At), r[m](), 
e.isPropagationStopped() && d.removeEventListener(m, At), k.event.triggered = void 0, 
u && (r[c] = u)), e.result;
}
},
...
var e = this.type;
return this.name && !k(this).is(":disabled") && qt.test(this.nodeName) && !$t.test(e) && (this.checked || !me.test(e));
}).map(function(e, t) {
var n = k(this).val();
...
var Lt = /%20/g, Gt = /#.*$/, Rt = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ht = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), zt = s.createElement("a");
function Ut(e) {
return function(t, n) {
...
function j(e, t, a, s) {
var l, p, d, x, w, _ = t;
c || (c = !0, u && n.clearTimeout(u), r = void 0, i = s || "", T.readyState = 0 < e ? 4 : 0, 
...
}(h, x, T, l), l ? (h.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (k.lastModified[o] = w), 
...
2 === Jt.childNodes.length), k.parseHTML = function(e, t, n) {
...
if (n) return n = Qe(e, t), Fe.test(n) ? k(e).position()[t] + "px" : n;
});
}), k.each({
Height: "height",
Width: "width"
...
k.isWindow = x, k.camelCase = J, k.type = T, k.now = Date.now, k.isNumeric = function(e) {
var t = k.type(e);
...
for (h && (C = e.substr(m + 1), A = this.parse(C, w), r = r.substr(0, g) + "\\[" + A[0], 
...
if (l) {
var _ = c(p[0]), T = c(p[1]), j = Math.max(p[0].length, p[1].length), k = 3 == p.length ? Math.abs(c(p[2])) : 1, C = v, A;
T < _ && (k *= -1, C = b);
var M = p.some(y);
w = [];
