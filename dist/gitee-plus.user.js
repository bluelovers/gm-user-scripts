...
// @author		bluelovers
//
// @description		於 Gitee 碼雲 增加一點小功能
...
// @downloadURL	https://github.com/bluelovers/gm-user-scripts/raw/master/dist/gitee-plus.user.js
// @updateURL	https://github.com/bluelovers/gm-user-scripts/raw/master/dist/gitee-plus.user.js
//
// @include		http*://gitee.com/*
// @include		http*://gitee.com/api/*
// @include		http*://gitee.com/oauth/applications/*
// @include		http*://m.gitee.com/*
//
// @match		
//
// @exclude		
...
e.exports.id = "gitee-plus", e.exports.version = "", e.exports.name = "gitee-plus", 
e.exports.name_en = "gitee-plus", e.exports.name_ja = "gitee-plus", e.exports.desc = "於 Gitee 碼雲 增加一點小功能", 
e.exports.desc_en = "於 Gitee 碼雲 增加一點小功能", e.exports.desc_ja = "於 Gitee 碼雲 增加一點小功能", 
e.exports.namespace = "", e.exports.author = "", e.exports.icon = "", e.exports.list = [ "base/gitee-plus" ], 
e.exports.list_disable = [], e.exports._lib = (() => {
n(7);
}), e.exports.metadata = {}, e.exports.metadata.include = [ "http*://gitee.com/*", "http*://gitee.com/api/*", "http*://gitee.com/oauth/applications/*", "http*://m.gitee.com/*" ], 
e.exports.metadata.match = [], e.exports.metadata.exclude = [], e.exports.metadata.grant = [ "GM.deleteValue", "GM.getValue", "GM.listValues", "GM.registerMenuCommand", "GM.setValue", "GM.unregisterMenuCommand", "GM.xmlhttpRequest", "GM_deleteValue", "GM_getValue", "GM_listValues", "GM_registerMenuCommand", "GM_setValue", "GM_unregisterMenuCommand", "GM_xmlhttpRequest", "unsafeWindow" ], 
...
let i = {
metadata: {
include: [ "http*://gitee.com/*", "http*://gitee.com/api/*", "http*://gitee.com/oauth/applications/*", "http*://m.gitee.com/*" ],
match: [],
nomatch: [],
exclude: [],
grant: []
...
test(r = t._url_obj) {
let o;
return !!(o = n(19).auto(r.source, e.exports));
},
async main(e = t._url_obj) {
const {debounce: o} = n(10), {throttle: i} = n(10), l = n(5), f = n(26);
f([]).prop("target", "_blank");
let p = a(e);
if (!p) return;
c(e);
try {
t.pathAutoRender = window.pathAutoRender = unsafeWindow.pathAutoRender, t.Tree = window.Tree = unsafeWindow.Tree, 
t.ajaxGet = window.ajaxGet = unsafeWindow.ajaxGet;
} catch (e) {
console.error(e);
}
const d = n(27), h = n(2);
n(28).makeJQueryPlugin(r, window);
const g = n(29);
function m() {
l.url(window.location.href, t, function(t, n, o) {
l.greasemonkey.debug("location", t, n._url_obj, o), e = n._url_obj, p = a(e), r(window).triggerHandler("popstate.ajax");
});
}
r("body").on("DOMNodeInserted", "#git-project-bread", function(e) {
let t = r("#git-project-bread .ui.right .item.table-btn"), n = r("#btn-dl-or-clone");
if (m(), r("#git-project-branch").css("border-color", function(e, t) {
return r("#btn-dl-or-clone").css("background-color") || t;
}), t.length || (r("#git-project-bread .ui.right").prepend('<div class="item table-btn"/>'), 
t = r("#git-project-bread .ui.right .item.table-btn")), n.length && t.length && !r("#edit-history", this).length && p.router.match(/^tree\/(.+)$/)) {
let e = RegExp.$1, n = r(`<a href="/${p.username}/${p.repo}/commits/${e}" class="btn-table-item" id="edit-history" title="歷史"><i class="iconfont icon-commit"></i> 歷史</a>`);
t.append(n);
}
}), r(window).on("load", o(1e3, function(e) {
console.log(e.type, e.namespace, e), f([ "#users-events .event-group a", "a.view-file, .git-commit-meta a" ].join(",")).prop("target", "_blank"), 
r("#git-project-bread").trigger("DOMNodeInserted");
})).on("load.ajax", i(200, function(t) {
console.log(t.type, t.namespace, t), r("#path-breadcrumb a.section:not(.repo-name)").off("click.ajax").on("click.ajax", function(e) {
d(e);
let t = r(this), n = t.parentsUntil("#path-breadcrumb");
n.length || (n = t), n.nextAll().remove();
let o = t.prop("href");
window.location.href != o && s(t.prop("href"));
}), u(e), r(window).triggerHandler("resize");
})).on("popstate.ajax", o(200, function(e) {
console.log(e.type, e.namespace, e), m(), r(window).triggerHandler("load");
})).on("resize", o(200, function() {
const t = /^m\./.test(e.host);
let n = r(window).innerWidth(), o = Math.min(1040, n);
t || (o -= 30), r("._pre_warp_area, .file_content").css({
"max-width": o
});
})).triggerHandler("load"), r("#project-app").on("DOMNodeInserted", o(500, function(e) {
r(".view-content").one("DOMNodeInserted", o(200, function(e) {
console.log(e.type, e.namespace, e), r(window).triggerHandler("load");
})), r(".file_content.code").length && r(window).triggerHandler("load");
}));
},
...
function a(e = t._url_obj) {
let n;
return e.path.match(/^\/([^\/]+)\/([^\/]+)(?:\/(.*))?$/) && (n = {
username: RegExp.$1,
repo: RegExp.$2,
router: RegExp.$3,
isajax: void 0 !== a.inited
}, console.info(n)), a.inited = !0, n;
}
function s(e, t) {
let n = {
headers: {
...
return console.log("state", history.state, e), r.getScript(e, Object.assign({}, t, Object.assign({
data: {
_: Date.now()
}
}, n, {
...
let o = history.state;
history.pushState(o, document.title, e), r(window).triggerHandler("popstate.ajax");
}).fail(function(e, t, n) {
...
function u(e = t._url_obj) {
const n = /^m\./.test(e.host);
let o = r(".file_content.code > .lines"), i;
if (r("._pre_warp_area").length) return;
let a = r('<div class="_pre_warp_area"/>');
o.find(".line-numbers a").each(function() {
let e = r(this), t = e.attr("id").replace(/^\D+/, ""), n = o.find(`#LC${t}`), s = r('<div class="_pre_warp_area_row"/>'), u = r('<div class="line-numbers"/>').appendTo(s), c = r("<pre/>").appendTo(r('<div class="highlight"/>').appendTo(s));
e.appendTo(u), n.appendTo(c), a.append(s), i = !0;
}), i && o.find("> .line-numbers, > .highlight").hide(), a.appendTo(o);
}
function c(e = t._url_obj) {
const n = /^m\./.test(e.host);
let i = r("body")[0];
o.GM_addStyle([ "._pre_warp_area { padding-top: 5px; padding-bottom: 5px; }", "._pre_warp_area .line-numbers, ._pre_warp_area pre { padding: 0 !important; padding-right: 5px !important; }", "._pre_warp_area pre { white-space: pre-wrap !important; }", "._pre_warp_area_row:hover .line-numbers { background: #1f8cd1 !important; }", ".ui.container { max-width: 1040px; auto: 1040px; }", "#project-app .file_holder .file_content.code .lines .line-numbers a { min-width: 20px; }", ".file_holder .file_content.code .lines .highlight pre .line { min-height: 1.33em; height: auto; }" ].join(""), i), 
console.log({
_url_obj: e,
_is_mobile: n
}), n ? o.GM_addStyle([ "body, html, :root { font-size: 9pt; }", ".markdown-body, .markdown-body pre { font-size: 1em !important; }" ].join("")) : o.GM_addStyle([ "body, html, :root { font-size: 9pt; }", ".markdown-body, .markdown-body pre, body.git-project .git-project-bread > .ui.horizontal.list .table-btn .btn-table-item, .ui.mini.buttons .button, .ui.mini.buttons .or, .ui.mini.button, .activity_content .event-note, body.git-project .tree-comment-form textarea { font-size: 1rem; }" ].join(""));
}
a || (a = {}), e.exports = i;
...
function c() {
var u = this, c = Date.now() - a, l = arguments;
function f() {
a = Date.now(), n.apply(u, l);
}
function p() {
o = void 0;
}
i || (r && !o && f(), s(), void 0 === r && c > e ? f() : !0 !== t && (o = setTimeout(r ? p : f, void 0 === r ? e - c : e)));
}
return "boolean" != typeof t && (r = n, n = t, t = void 0), c.cancel = u, c;
}
function o(e, t, n) {
...
Object.defineProperty(t, "__esModule", {
value: !0
}), t.desc = "於 Gitee 碼雲 增加一點小功能", t.desc_en = t.desc, t.icon = "", t.grant = [ "GM_registerMenuCommand", "GM_xmlhttpRequest", "unsafeWindow", "GM_deleteValue", "GM_getValue", "GM_listValues", "GM_setValue" ], 
...
var k = function(e) {
var t, n, r, o, i, a, s, u, c, l, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, j = 0, T = ae(), C = ae(), M = ae(), A = function(e, t) {
return e === t && (f = !0), 0;
}, k = {}.hasOwnProperty, E = [], S = E.pop, D = E.push, N = E.push, $ = E.slice, O = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, G = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", q = "[\\x20\\t\\r\\n\\f]", L = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + q + "*(" + L + ")(?:" + q + "*([*^$|!~]?=)" + q + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + L + "))|)" + q + "*\\]", H = ":(" + L + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", P = new RegExp(q + "+", "g"), I = new RegExp("^" + q + "+|((?:^|[^\\\\])(?:\\\\.)*)" + q + "+$", "g"), W = new RegExp("^" + q + "*," + q + "*"), F = new RegExp("^" + q + "*([>+~]|" + q + ")" + q + "*"), B = new RegExp("=" + q + "*([^\\]'\"]*?)" + q + "*\\]", "g"), U = new RegExp(H), V = new RegExp("^" + L + "$"), z = {
ID: new RegExp("^#(" + L + ")"),
CLASS: new RegExp("^\\.(" + L + ")"),
TAG: new RegExp("^(" + L + "|[*])"),
ATTR: new RegExp("^" + R),
...
}, Q = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + q + "?|(" + q + ")|.)", "ig"), ee = function(e, t, n) {
var r = "0x" + t - 65536;
...
e.querySelectorAll("[selected]").length || m.push("\\[" + q + "*(?:value|" + G + ")"), 
...
t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && m.push("name" + q + "*[*^$|!~]?="), 
...
if ((e.ownerDocument || e) !== d && p(e), t = t.replace(B, "='$1']"), n.matchesSelector && g && !M[t + " "] && (!y || !y.test(t)) && (!m || !m.test(t))) try {
var r = v.call(e, t);
...
var o = r.attrHandle[t.toLowerCase()], i = o && k.call(r.attrHandle, t.toLowerCase()) ? o(e, t, !g) : void 0;
...
for (l = y.length; l--; ) (f = y[l]) && (c = o ? O(i, f) : p[l]) > -1 && (i[c] = !(a[c] = f));
}
...
value: " " === e[u - 2].type ? "*" : ""
})).replace(I, "$1"), n, u < o && je(e.slice(u, o)), o < i && je(e = e.slice(o)), o < i && ye(e));
}
p.push(n);
}
return be(p);
...
var f, h, m, y = 0, v = "0", b = i && [], x = [], w = c, j = i || o && r.find.TAG("*", l), T = _ += null == w ? 1 : Math.random() || .1, C = j.length;
for (l && (c = a === d || a || l); v !== C && null != (f = j[v]); v++) {
if (o && f) {
...
N.apply(u, x), l && !i && x.length > 0 && y + t.length > 1 && ie.uniqueSort(u);
}
return l && (_ = T, c = w), b;
};
return n ? se(i) : i;
...
C.find = k, C.expr = k.selectors, C.expr[":"] = C.expr.pseudos, C.uniqueSort = C.unique = k.uniqueSort, 
C.text = k.getText, C.isXMLDoc = k.isXML, C.contains = k.contains, C.escapeSelector = k.escape;
...
is: function(e) {
return !!O(this, "string" == typeof e && D.test(e) ? C(e) : e || [], !1).length;
}
});
var G, q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
...
}).prototype = C.fn, G = C(s);
var L = /^(?:parents|prev(?:Until|All))/, R = {
children: !0,
contents: !0,
next: !0,
prev: !0
...
if (!D.test(e)) for (;r < o; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && C.find.matchesSelector(n, e))) {
i.push(n);
break;
}
...
this.length > 1 && (R[e] || C.uniqueSort(o), L.test(e) && o.reverse()), this.pushStack(o);
};
});
var P = /[^\x20\t\r\n\f]+/g;
function I(e) {
...
b(r) ? e.unique && c.has(r) || i.push(r) : r && r.length && "string" !== j(r) && t(r);
});
...
c = n && ("object" == typeof n || "function" == typeof n) && n.then, b(c) ? o ? c.call(n, a(i, t, W, o), a(i, t, F, o)) : (i++, 
c.call(n, a(i, t, W, o), a(i, t, F, o), a(i, t, W, t.notifyWith))) : (r !== W && (s = void 0, 
...
C.Deferred.exceptionHook && C.Deferred.exceptionHook(n, l.stackTrace), e + 1 >= i && (r !== F && (s = void 0, 
...
readyWait: 1,
ready: function(e) {
(!0 === e ? --C.readyWait : C.isReady) || (C.isReady = !0, !0 !== e && --C.readyWait > 0 || V.resolveWith(s, [ C ]));
}
}), C.ready.then = V.then, "complete" === s.readyState || "loading" !== s.readyState && !s.documentElement.doScroll ? n.setTimeout(C.ready) : (s.addEventListener("DOMContentLoaded", z), 
...
for (var i, a, s, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === j(i)) C.merge(p, i.nodeType ? [ i ] : i); else if (_e.test(i)) {
...
var Te = s.documentElement, Ce = /^key/, Me = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ae = /^([^.]*)(?:\.(.+)|)/;
function ke() {
return !0;
}
function Ee() {
...
if (m) for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(Te, o), 
...
e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? ke : Ee, 
...
var Ne = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, $e = /<script|<style|<link/i, Oe = /checked\s*(?:[^=]|=\s*.checked.)/i, Ge = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
function qe(e, t) {
...
i || r)) {
for (s = (a = C.map(xe(o, "script"), Le)).length; f < p; f++) u = o, f !== d && (u = C.clone(u, !0, !0), 
s && C.merge(a, xe(u, "script"))), n.call(e[f], u, f);
if (s) for (c = a[a.length - 1].ownerDocument, C.map(a, Re), f = 0; f < s; f++) u = a[f], 
ve.test(u.type || "") && !te.access(u, "globalEval") && C.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : _(u.textContent.replace(Ge, ""), c, u));
}
return e;
}
function We(e, t, n) {
...
var Fe = new RegExp("^(" + se + ")(?!px)[a-z%]+$", "i"), Be = function(e) {
var t = e.ownerDocument.defaultView;
return t && t.opener || (t = n), t.getComputedStyle(e);
}, Ue = new RegExp(ce.join("|"), "i");
function Ve(e, t, n) {
var r, o, i, a, s = e.style;
return (n = n || Be(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || C.contains(e.ownerDocument, e) || (a = C.style(e, t)), 
!v.pixelBoxStyles() && Fe.test(a) && Ue.test(t) && (r = s.width, o = s.minWidth, 
...
function ot(e, t, n) {
var r = Be(e), o = Ve(e, t, r), i = "border-box" === C.css(e, "boxSizing", !1, r), a = i;
if (Fe.test(o)) {
if (!n) return o;
o = "auto";
}
...
void 0 === o && (o = Ve(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), 
!0 === n || isFinite(i) ? i || 0 : o) : o;
}
}), C.each([ "height", "width" ], function(e, t) {
C.cssHooks[t] = {
get: function(e, n, r) {
if (n) return !Qe.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ot(e, t, r) : fe(e, Ye, function() {
return ot(e, t, r);
});
},
set: function(e, n, r) {
var o, i = Be(e), a = "border-box" === C.css(e, "boxSizing", !1, i), s = r && rt(e, t, r, a, i);
...
var t, o, i, a;
if (r) for (o = 0, i = C(this), a = jt(e); t = a[o++]; ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = _t(this)) && te.set(this, "__className__", t), 
...
C.event.triggered = m, e.isPropagationStopped() && d.addEventListener(m, Mt), r[m](), 
e.isPropagationStopped() && d.removeEventListener(m, Mt), C.event.triggered = void 0, 
u && (r[l] = u)), e.result;
}
},
...
var At = n.location, kt = Date.now(), Et = /\?/;
...
var e = this.type;
return this.name && !C(this).is(":disabled") && $t.test(this.nodeName) && !Nt.test(e) && (this.checked || !me.test(e));
}).map(function(e, t) {
var n = C(this).val();
...
var Gt = /%20/g, qt = /#.*$/, Lt = /([?&])_=[^&]*/, Rt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Ft = {}, Bt = "*/".concat("*"), Ut = s.createElement("a");
function Vt(e) {
return function(t, n) {
...
var r, o, i, a, u, c, l, f, p, d, h = C.ajaxSetup({}, t), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? C(g) : C.event, y = C.Deferred(), v = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, _ = "canceled", j = {
readyState: 0,
...
zt(Wt, h, t, j), l) return j;
for (p in (f = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), 
h.type = h.type.toUpperCase(), h.hasContent = !Pt.test(h.type), o = h.url.replace(qt, ""), 
h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Gt, "+")) : (d = h.url.slice(o.length), 
h.data && (h.processData || "string" == typeof h.data) && (o += (Et.test(o) ? "&" : "?") + h.data, 
delete h.data), !1 === h.cache && (o = o.replace(Lt, "$1"), d = (Et.test(o) ? "&" : "?") + "_=" + kt++ + d), 
...
if (_ = "abort", v.add(h.complete), j.done(h.success), j.fail(h.error), r = zt(Ft, h, t, j)) {
...
function T(e, t, a, s) {
var c, p, d, x, w, _ = t;
l || (l = !0, u && n.clearTimeout(u), r = void 0, i = s || "", j.readyState = e > 0 ? 4 : 0, 
c = e >= 200 && e < 300 || 304 === e, a && (x = Xt(h, j, a)), x = Yt(h, x, j, c), 
c ? (h.ifModified && ((w = j.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w), 
...
j.status = e, j.statusText = (t || _) + "", c ? y.resolveWith(g, [ p, _, j ]) : y.rejectWith(g, [ j, _, d ]), 
j.statusCode(b), b = void 0, f && m.trigger(c ? "ajaxSuccess" : "ajaxError", [ j, h, c ? p : d ]), 
...
}, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = N, C.isFunction = b, 
C.isWindow = x, C.camelCase = K, C.type = j, C.now = Date.now, C.isNumeric = function(e) {
var t = C.type(e);
...
var r = {
"./gitee-plus/": 3,
"./gitee-plus/base/gitee-plus": 7,
"./gitee-plus/base/gitee-plus.js": 7,
"./gitee-plus/index": 3,
"./gitee-plus/index.js": 3,
"./gitee-plus/index.user": 4,
"./gitee-plus/index.user.js": 4,
"./gitee-plus/lib/metadata": 11,
"./gitee-plus/lib/metadata.js": 11
};
function o(e) {
var t = i(e);
return n(t);
...
}, o.resolve = i, e.exports = o, o.id = 18;
}, function(e, t, n) {
"use strict";
Object.defineProperty(t, "__esModule", {
value: !0
});
const r = n(20), o = r.Minimatch;
function i(e, t, n = {}) {
n = a(n);
let o = !1;
...
var o = m.GLOBSTAR = y.GLOBSTAR = {}, i = n(23), a = {
"!": {
open: "(?:(?!(?:",
close: "))[^/]*?)"
},
...
default:
b(), c ? c = !1 : !f[j] || "^" === j && h || (r += "\\"), r += j;
}
for (h && (M = e.substr(m + 1), A = this.parse(M, w), r = r.substr(0, g) + "\\[" + A[0], 
i = i || A[1]), T = l.pop(); T; T = l.pop()) {
var k = r.slice(T.reStart + T.open.length);
this.debug("setting tail", r, T), k = k.replace(/((?:\\{2}){0,64})(\\?)\|/g, function(e, t, n) {
return n || (n = "\\"), t + t + n + "|";
}), this.debug("tail=%j\n   %s", k, k, T, r);
var E = "*" === T.type ? u : "?" === T.type ? s : "\\" + T.type;
i = !0, r = r.slice(0, T.reStart) + E + "\\(" + k;
}
b(), c && (r += "\\\\");
var S = !1;
switch (r.charAt(0)) {
...
var N = p[D], $ = r.slice(0, N.reStart), O = r.slice(N.reStart, N.reEnd - 8), G = r.slice(N.reEnd - 8, N.reEnd), q = r.slice(N.reEnd);
G += q;
var L = $.split("(").length - 1, R = q;
for (x = 0; x < L; x++) R = R.replace(/\)[+*?]?/, "");
var H = "", P;
"" === (q = R) && t !== w && (H = "$"), r = $ + O + q + H + G;
}
...
if (c) {
var _ = l(p[0]), j = l(p[1]), T = Math.max(p[0].length, p[1].length), C = 3 == p.length ? Math.abs(l(p[2])) : 1, M = v, A;
j < _ && (C *= -1, M = b);
var k = p.some(y);
w = [];
...
let r = e.Event(n);
return Object.assign(r, t), console.log("triggerKey", this, r), this.trigger(r);
};
});
}).call(this, n(1));
}, function(e, t, n) {
