...
var A = function(e) {
var t, n, r, o, i, a, s, u, l, c, f, p, d, h, m, g, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, j = 0, T = ae(), C = ae(), M = ae(), k = function(e, t) {
return e === t && (f = !0), 0;
}, A = {}.hasOwnProperty, E = [], S = E.pop, N = E.push, D = E.push, O = E.slice, q = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", $ = "[\\x20\\t\\r\\n\\f]", G = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", H = "\\[" + $ + "*(" + G + ")(?:" + $ + "*([*^$|!~]?=)" + $ + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + G + "))|)" + $ + "*\\]", R = ":(" + G + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + H + ")*)|.*)\\)|)", P = new RegExp($ + "+", "g"), I = new RegExp("^" + $ + "+|((?:^|[^\\\\])(?:\\\\.)*)" + $ + "+$", "g"), W = new RegExp("^" + $ + "*," + $ + "*"), B = new RegExp("^" + $ + "*([>+~]|" + $ + ")" + $ + "*"), F = new RegExp("=" + $ + "*([^\\]'\"]*?)" + $ + "*\\]", "g"), U = new RegExp(R), z = new RegExp("^" + G + "$"), Q = {
ID: new RegExp("^#(" + G + ")"),
CLASS: new RegExp("^\\.(" + G + ")"),
TAG: new RegExp("^(" + G + "|[*])"),
ATTR: new RegExp("^" + H),
...
}, V = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + $ + "?|(" + $ + ")|.)", "ig"), ee = function(e, t, n) {
var r = "0x" + t - 65536;
...
try {
D.apply(E = O.call(w.childNodes), w.childNodes), E[w.childNodes.length].nodeType;
} catch (e) {
D = {
...
e.querySelectorAll("[selected]").length || g.push("\\[" + $ + "*(?:value|" + L + ")"), 
...
t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && g.push("name" + $ + "*[*^$|!~]?="), 
...
if ((e.ownerDocument || e) !== d && p(e), t = t.replace(F, "='$1']"), n.matchesSelector && m && !M[t + " "] && (!y || !y.test(t)) && (!g || !g.test(t))) try {
var r = v.call(e, t);
...
var f, h, g, y = 0, v = "0", b = i && [], x = [], w = l, j = i || o && r.find.TAG("*", c), T = _ += null == w ? 1 : Math.random() || .1, C = j.length;
...
for (i = Q.needsContext.test(e) ? 0 : u.length; i-- && (l = u[i], !r.relative[c = l.type]); ) if ((f = r.find[c]) && (o = f(l.matches[0].replace(Z, ee), K.test(u[0].type) && me(t.parentNode) || t))) {
...
this.length > 1 && (H[e] || C.uniqueSort(o), G.test(e) && o.reverse()), this.pushStack(o);
};
});
var P = /[^\x20\t\r\n\f]+/g;
function I(e) {
...
for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === j(i)) C.merge(p, i.nodeType ? [ i ] : i); else if (_e.test(i)) {
...
var Te = s.documentElement, Ce = /^key/, Me = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ke = /^([^.]*)(?:\.(.+)|)/;
function Ae() {
return !0;
}
function Ee() {
...
if (g) for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(Te, o), 
n.guid || (n.guid = C.guid++), (u = g.events) || (u = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
return void 0 !== C && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0;
}), l = (t = (t || "").match(P) || [ "" ]).length; l--; ) d = m = (s = ke.exec(t[l]) || [])[1], 
...
if (g && (u = g.events)) {
for (l = (t = (t || "").match(P) || [ "" ]).length; l--; ) if (d = m = (s = ke.exec(t[l]) || [])[1], 
h = (s[2] || "").split(".").sort(), d) {
...
var De = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, Oe = /<script|<style|<link/i, qe = /checked\s*(?:[^=]|=\s*.checked.)/i, Le = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
function $e(e, t) {
...
if (m || p > 1 && "string" == typeof h && !v.checkClone && qe.test(h)) return e.each(function(o) {
var i = e.eq(o);
...
ve.test(u.type || "") && !te.access(u, "globalEval") && C.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : _(u.textContent.replace(Le, ""), l, u));
}
return e;
}
function We(e, t, n) {
...
null == (l = g && g.display) && (l = te.get(e, "display")), "none" === (c = C.css(e, "display")) && (l ? c = l : (me([ e ], !0), 
l = e.style.display || l, c = C.css(e, "display"), me([ e ]))), ("inline" === c || "inline-block" === c && null != l) && "none" === C.css(e, "float") && (u || (p.done(function() {
h.display = l;
...
for (r in m || me([ e ]), te.remove(e, "fxshow"), d) C.style(e, r, d[r]);
...
function gt(e, t, n) {
var r, o, i = 0, a = gt.prefilters.length, s = C.Deferred().always(function() {
delete u.elem;
}), u = function() {
if (o) return !1;
...
for (mt(c, l.opts.specialEasing); i < a; i++) if (r = gt.prefilters[i].call(l, e, c, l.opts)) return b(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), 
r;
...
if (a = d = u = r = r || s, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(g + C.event.triggered) && (g.indexOf(".") > -1 && (g = (y = g.split(".")).shift(), 
y.sort()), c = g.indexOf(":") < 0 && "on" + g, (e = e[C.expando] ? e : new C.Event(g, "object" == typeof e && e)).isTrigger = o ? 2 : 3, 
...
p = C.event.special[g] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, t))) {
if (!o && !p.noBubble && !x(r)) {
...
C.event.triggered = g, e.isPropagationStopped() && d.addEventListener(g, Mt), r[g](), 
e.isPropagationStopped() && d.removeEventListener(g, Mt), C.event.triggered = void 0, 
u && (r[c] = u)), e.result;
}
},
...
var kt = n.location, At = Date.now(), Et = /\?/;
...
var e = this.type;
return this.name && !C(this).is(":disabled") && Ot.test(this.nodeName) && !Dt.test(e) && (this.checked || !ge.test(e));
}).map(function(e, t) {
var n = C(this).val();
...
var Lt = /%20/g, $t = /#.*$/, Gt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, Rt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), Ut = s.createElement("a");
function zt(e) {
return function(t, n) {
...
var r, o, i, a, u, l, c, f, p, d, h = C.ajaxSetup({}, t), m = h.context || h, g = h.context && (m.nodeType || m.jquery) ? C(m) : C.event, y = C.Deferred(), v = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, _ = "canceled", j = {
readyState: 0,
...
h.type = h.type.toUpperCase(), h.hasContent = !Pt.test(h.type), o = h.url.replace($t, ""), 
...
v.fireWith(m, [ j, _ ]), f && (g.trigger("ajaxComplete", [ j, h ]), --C.active || C.event.trigger("ajaxStop")));
}
return j;
},
...
t.head.appendChild(r)) : t = s), i = !n && [], (o = O.exec(e)) ? [ t.createElement(o[1]) ] : (o = je([ e ], t, i), 
...
var o = g.GLOBSTAR = y.GLOBSTAR = {}, i = n(32), a = {
"!": {
open: "(?:(?!(?:",
close: "))[^/]*?)"
},
...
if (h) {
var M = e.substring(g + 1, x);
try {
RegExp("[" + M + "]");
} catch (e) {
var k = this.parse(M, w);
r = r.substr(0, m) + "\\[" + k[0] + "\\]", i = i || k[1], h = !1;
continue;
}
}
i = !0, h = !1, r += j;
...
for (h && (M = e.substr(g + 1), k = this.parse(M, w), r = r.substr(0, m) + "\\[" + k[0], 
