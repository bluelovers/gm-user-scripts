...
const i = n(25), a = n(26), s = n(27).GMApi, u = n(28), l = n(29);
...
{
let e = o(".fl_tb").eq(0), t = o(".fl_g", e);
if (t.length) {
r.GM_addStyle([ "._fl_tb_block ._fl_tb_tr_block { display: block; }", "._fl_tb_block .fl_g { display: inline-block; }" ]), 
e.addClass("_fl_tb_block");
let n = t.eq(0).parents("tr:eq(0)").eq(0);
n.addClass("_fl_tb_tr_block"), t.each(function(e, t) {
let n = o(t);
...
let n = o(e).hasClass("_has_new_post") ? 1 : 0, r, i = (o(t).hasClass("_has_new_post") ? 1 : 0) - n;
if (!i) {
let n = o(e).hasClass("_has_unread_post") ? 1 : 0, r;
i = (o(t).hasClass("_has_unread_post") ? 1 : 0) - n;
}
return i;
}).appendTo(n);
}
}
let c = o("#postlist"), f = c.find('> div[id^="post_"]');
if (c.length && f.length) {
let e = [];
f.each(function(e, t) {
let n = o(this), r = n.attr("id"), i = o('[id^="postmessage_"]:eq(0)', n).eq(0);
u.hide_userinfo(n);
let a = n.find(".authi").eq(0).text(), s = i.text().replace(/\n+/, "\n").replace(/^\s+/, "").slice(0, 50);
}), e.length;
}
if (o("body.pg_task").length) {
let e = o('#ct .bbda a:has(> img[alt="apply"])');
...
var k = function(e) {
var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, T = 0, j = ae(), C = ae(), M = ae(), A = function(e, t) {
return e === t && (f = !0), 0;
}, k = {}.hasOwnProperty, E = [], S = E.pop, N = E.push, D = E.push, q = E.slice, G = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", $ = "[\\x20\\t\\r\\n\\f]", L = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + $ + "*(" + L + ")(?:" + $ + "*([*^$|!~]?=)" + $ + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + L + "))|)" + $ + "*\\]", P = ":(" + L + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", H = new RegExp($ + "+", "g"), I = new RegExp("^" + $ + "+|((?:^|[^\\\\])(?:\\\\.)*)" + $ + "+$", "g"), W = new RegExp("^" + $ + "*," + $ + "*"), B = new RegExp("^" + $ + "*([>+~]|" + $ + ")" + $ + "*"), F = new RegExp("=" + $ + "*([^\\]'\"]*?)" + $ + "*\\]", "g"), V = new RegExp(P), U = new RegExp("^" + L + "$"), z = {
ID: new RegExp("^#(" + L + ")"),
CLASS: new RegExp("^\\.(" + L + ")"),
TAG: new RegExp("^(" + L + "|[*])"),
ATTR: new RegExp("^" + R),
...
}, Q = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + $ + "?|(" + $ + ")|.)", "ig"), ee = function(e, t, n) {
var r = "0x" + t - 65536;
...
try {
D.apply(E = q.call(w.childNodes), w.childNodes), E[w.childNodes.length].nodeType;
} catch (e) {
D = {
...
e.querySelectorAll("[selected]").length || m.push("\\[" + $ + "*(?:value|" + O + ")"), 
...
t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && m.push("name" + $ + "*[*^$|!~]?="), 
...
for (c = y.length; c--; ) (f = y[c]) && (l = o ? G(i, f) : p[c]) > -1 && (i[l] = !(a[l] = f));
}
...
var f, h, m, y = 0, v = "0", b = i && [], x = [], w = l, T = i || o && r.find.TAG("*", c), j = _ += null == w ? 1 : Math.random() || .1, C = T.length;
for (c && (l = a === d || a || c); v !== C && null != (f = T[v]); v++) {
if (o && f) {
...
is: function(e) {
return !!G(this, "string" == typeof e && N.test(e) ? C(e) : e || [], !1).length;
}
});
var O, $ = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
...
q.test(r[1]) && C.isPlainObject(t)) for (r in t) b(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
return this;
}
...
b(r) ? e.unique && l.has(r) || i.push(r) : r && r.length && "string" !== T(r) && t(r);
});
...
for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === T(i)) C.merge(p, i.nodeType ? [ i ] : i); else if (_e.test(i)) {
...
}), l = (t = (t || "").match(H) || [ "" ]).length; l--; ) d = g = (s = Ae.exec(t[l]) || [])[1], 
...
if (m && (u = m.events)) {
for (l = (t = (t || "").match(H) || [ "" ]).length; l--; ) if (d = g = (s = Ae.exec(t[l]) || [])[1], 
h = (s[2] || "").split(".").sort(), d) {
...
var De = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, qe = /<script|<style|<link/i, Ge = /checked\s*(?:[^=]|=\s*.checked.)/i, Oe = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
function $e(e, t) {
...
if (g || p > 1 && "string" == typeof h && !v.checkClone && Ge.test(h)) return e.each(function(o) {
var i = e.eq(o);
...
ve.test(u.type || "") && !te.access(u, "globalEval") && C.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : _(u.textContent.replace(Oe, ""), l, u));
}
return e;
}
function We(e, t, n) {
...
r = 0, o = (i = xe(e)).length; r < o; r++) He(i[r], a[r]);
...
n || St.test(e) ? r(e, o) : Gt(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, r);
}); else if (n || "object" !== T(t)) r(e, t); else for (o in t) Gt(e + "[" + o + "]", t[o], n, r);
}
...
var Ot = /%20/g, $t = /#.*$/, Lt = /([?&])_=[^&]*/, Rt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Pt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ht = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), Vt = s.createElement("a");
function Ut(e) {
return function(t, n) {
...
var r, o, i, a, u, l, c, f, p, d, h = C.ajaxSetup({}, t), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? C(g) : C.event, y = C.Deferred(), v = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, _ = "canceled", T = {
readyState: 0,
...
zt(Wt, h, t, T), c) return T;
for (p in (f = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), 
h.type = h.type.toUpperCase(), h.hasContent = !Ht.test(h.type), o = h.url.replace($t, ""), 
...
function j(e, t, a, s) {
var l, p, d, x, w, _ = t;
c || (c = !0, u && n.clearTimeout(u), r = void 0, i = s || "", T.readyState = e > 0 ? 4 : 0, 
l = e >= 200 && e < 300 || 304 === e, a && (x = Xt(h, T, a)), x = Yt(h, x, T, l), 
l ? (h.ifModified && ((w = T.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w), 
...
T.status = e, T.statusText = (t || _) + "", l ? y.resolveWith(g, [ p, _, T ]) : y.rejectWith(g, [ T, _, d ]), 
T.statusCode(b), b = void 0, f && m.trigger(l ? "ajaxSuccess" : "ajaxError", [ T, h, l ? p : d ]), 
...
t.head.appendChild(r)) : t = s), i = !n && [], (o = q.exec(e)) ? [ t.createElement(o[1]) ] : (o = Te([ e ], t, i), 
...
var r = {
"./masiro-moe/": 2,
"./masiro-moe/base/masiro-moe": 6,
"./masiro-moe/base/masiro-moe.js": 6,
"./masiro-moe/index": 2,
"./masiro-moe/index.js": 2,
"./masiro-moe/index.user": 3,
"./masiro-moe/index.user.js": 3,
"./masiro-moe/lib/metadata": 11,
"./masiro-moe/lib/metadata.js": 11
};
function o(e) {
var t = i(e);
return n(t);
...
var D = p[N], q = r.slice(0, D.reStart), G = r.slice(D.reStart, D.reEnd - 8), O = r.slice(D.reEnd - 8, D.reEnd), $ = r.slice(D.reEnd);
O += $;
var L = q.split("(").length - 1, R = $;
...
if (l) {
var _ = c(p[0]), T = c(p[1]), j = Math.max(p[0].length, p[1].length), C = 3 == p.length ? Math.abs(c(p[2])) : 1, M = v, A;
T < _ && (C *= -1, M = b);
var k = p.some(y);
w = [];
...
for (var q = 0; q < w.length; q++) for (var G = 0; G < h.length; G++) {
var O = g + w[q] + h[G];
(!t || l || O) && n.push(O);
}
return n;
...
let o = e('<div class="_pls_sub"/>');
console.log(o, r), r.after(o), r.nextAll().appendTo(o);
}
function r() {}
Object.defineProperty(t, "__esModule", {
value: !0
