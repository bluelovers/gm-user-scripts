...
const a = n(9), s = n(11).copyonclick;
function u() {
let e = r("#editor");
if (e.length) {
...
t.attr("id", "_body"), r("body").html(t).prepend('<div style="padding: 10px; text-align: center;"><button id="_copy">Copy</button></div>'), 
r("#_copy").attr("onclick", s(t.attr("id"))), o.GM_addStyle([ "body > div { margin: auto; max-width: 800px; }", "p { line-height: 110%; margin-block-start: auto; margin-block-end: auto; }", ":root, body, html { font-size: 9pt; font-family: initial !important; }" ], r("body")), 
console.timeEnd("_fn_editor");
}
}
a.registerMenuCommand({
id: e.exports.name,
key: "破壞石墨網頁"
}, e => {
u();
...
var k = function(e) {
var t, n, r, o, i, a, s, u, c, l, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, T = 0, j = ae(), C = ae(), M = ae(), A = function(e, t) {
return e === t && (f = !0), 0;
}, k = {}.hasOwnProperty, E = [], S = E.pop, N = E.push, D = E.push, $ = E.slice, O = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", L = "[\\x20\\t\\r\\n\\f]", G = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", R = "\\[" + L + "*(" + G + ")(?:" + L + "*([*^$|!~]?=)" + L + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + G + "))|)" + L + "*\\]", H = ":(" + G + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", P = new RegExp(L + "+", "g"), I = new RegExp("^" + L + "+|((?:^|[^\\\\])(?:\\\\.)*)" + L + "+$", "g"), W = new RegExp("^" + L + "*," + L + "*"), B = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"), F = new RegExp("=" + L + "*([^\\]'\"]*?)" + L + "*\\]", "g"), z = new RegExp(H), U = new RegExp("^" + G + "$"), Q = {
ID: new RegExp("^#(" + G + ")"),
CLASS: new RegExp("^\\.(" + G + ")"),
TAG: new RegExp("^(" + G + "|[*])"),
ATTR: new RegExp("^" + R),
...
try {
D.apply(E = $.call(w.childNodes), w.childNodes), E[w.childNodes.length].nodeType;
} catch (e) {
D = {
...
if ((e.ownerDocument || e) !== d && p(e), t = t.replace(F, "='$1']"), n.matchesSelector && g && !M[t + " "] && (!y || !y.test(t)) && (!m || !m.test(t))) try {
var r = v.call(e, t);
...
PSEUDO: function(e) {
var t, n = !e[6] && e[2];
return Q.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && z.test(n) && (t = a(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
...
for (i = Q.needsContext.test(e) ? 0 : u.length; i-- && (c = u[i], !r.relative[l = c.type]); ) if ((f = r.find[l]) && (o = f(c.matches[0].replace(Z, ee), K.test(u[0].type) && ge(t.parentNode) || t))) {
...
}), C.ready.then = U.then, "complete" === s.readyState || "loading" !== s.readyState && !s.documentElement.doScroll ? n.setTimeout(C.ready) : (s.addEventListener("DOMContentLoaded", Q), 
...
var je = s.documentElement, Ce = /^key/, Me = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ae = /^([^.]*)(?:\.(.+)|)/;
function ke() {
return !0;
}
function Ee() {
...
ve.test(u.type || "") && !te.access(u, "globalEval") && C.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(u.src) : _(u.textContent.replace(qe, ""), c, u));
}
return e;
}
function We(e, t, n) {
...
function ot(e, t, n) {
var r = Fe(e), o = Ue(e, t, r), i = "border-box" === C.css(e, "boxSizing", !1, r), a = i;
if (Be.test(o)) {
if (!n) return o;
o = "auto";
}
...
void 0 === o && (o = Ue(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), 
...
var qt = /%20/g, Lt = /#.*$/, Gt = /([?&])_=[^&]*/, Rt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pt = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), zt = s.createElement("a");
function Ut(e) {
return function(t, n) {
...
delete h.data), !1 === h.cache && (o = o.replace(Gt, "$1"), d = (Et.test(o) ? "&" : "?") + "_=" + kt++ + d), 
