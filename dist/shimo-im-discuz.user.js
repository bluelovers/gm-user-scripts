// ==UserScript==
// @name		shimo-im-discuz
// @name:en		shimo-im-discuz
// @name:ja		shimo-im-discuz
// @name:zh		shimo-im-discuz
// @namespace	bluelovers
// @author		bluelovers
//
// @description		暴力複製破壞石墨網頁讓他可以正常複製格式到 discuz 論壇
// @description:en	暴力複製破壞石墨網頁讓他可以正常複製格式到 discuz 論壇
...
// @downloadURL	https://github.com/bluelovers/gm-user-scripts/raw/master/dist/shimo-im-discuz.user.js
// @updateURL	https://github.com/bluelovers/gm-user-scripts/raw/master/dist/shimo-im-discuz.user.js
//
// @include		http*://shimo.im/docs/*
//
// @match		
//
// @exclude		
...
e.exports.id = "shimo-im-discuz", e.exports.version = "", e.exports.name = "shimo-im-discuz", 
e.exports.name_en = "shimo-im-discuz", e.exports.name_ja = "shimo-im-discuz", e.exports.desc = "暴力複製破壞石墨網頁讓他可以正常複製格式到 discuz 論壇", 
e.exports.desc_en = "暴力複製破壞石墨網頁讓他可以正常複製格式到 discuz 論壇", e.exports.desc_ja = "暴力複製破壞石墨網頁讓他可以正常複製格式到 discuz 論壇", 
e.exports.namespace = "", e.exports.author = "", e.exports.icon = "", e.exports.list = [ "base/shimo-im-discuz" ], 
e.exports.list_disable = [], e.exports._lib = (() => {
n(4);
}), e.exports.metadata = {}, e.exports.metadata.include = [ "http*://shimo.im/docs/*" ], 
e.exports.metadata.match = [], e.exports.metadata.exclude = [], e.exports.metadata.grant = [ "GM.registerMenuCommand", "GM.unregisterMenuCommand", "GM_registerMenuCommand", "GM_unregisterMenuCommand" ], 
...
async main(i = t._url_obj) {
n(25).makeJQueryPlugin(r, window);
const s = n(8), u = n(26).copyonclick;
function c() {
let e = r("#editor");
if (e.length) {
console.time("_fn_editor");
let t = r("> .ql-editor", e).clone();
r("style, script, link").each(function() {
this.disabled = !0;
}).attr("disabled", "disabled").remove(), t.removeAttr("contenteditable").removeAttr("class").removeAttr("style"), 
r(":root").html("<body/>"), r("html, :root, body").removeAttr("lang").removeAttr("style"), 
t.attr("id", "_body"), a(t.find("p")), r("body").html(t).prepend('<div style="padding: 10px; text-align: center;"><button id="_copy">Copy</button></div>'), 
r("#_copy").attr("onclick", u(t.attr("id"))), o.GM_addStyle([ "body > div { margin: auto; max-width: 800px; }", "p { line-height: 110%; margin-block-start: auto; margin-block-end: auto; }", ":root, body, html { font-size: 9pt; font-family: initial !important; }" ], r("body")), 
console.timeEnd("_fn_editor");
}
}
s.registerMenuCommand({
id: e.exports.name,
key: "破壞石墨網頁"
}, e => {
c();
...
var k = function(e) {
var t, n, r, o, i, a, s, u, c, l, f, p, d, h, g, m, y, v, b, x = "sizzle" + 1 * new Date(), w = e.document, _ = 0, j = 0, T = ue(), C = ue(), M = ue(), A = ue(), k = function(e, t) {
return e === t && (f = !0), 0;
}, S = {}.hasOwnProperty, E = [], N = E.pop, D = E.push, $ = E.push, O = E.slice, q = function(e, t) {
for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
return -1;
}, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", G = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", H = "\\[" + G + "*(" + R + ")(?:" + G + "*([*^$|!~]?=)" + G + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + G + "*\\]", P = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + H + ")*)|.*)\\)|)", I = new RegExp(G + "+", "g"), W = new RegExp("^" + G + "+|((?:^|[^\\\\])(?:\\\\.)*)" + G + "+$", "g"), B = new RegExp("^" + G + "*," + G + "*"), F = new RegExp("^" + G + "*([>+~]|" + G + ")" + G + "*"), z = new RegExp(G + "|>"), U = new RegExp(P), Q = new RegExp("^" + R + "$"), V = {
ID: new RegExp("^#(" + R + ")"),
CLASS: new RegExp("^\\.(" + R + ")"),
TAG: new RegExp("^(" + R + "|[*])"),
ATTR: new RegExp("^" + H),
...
try {
$.apply(E = O.call(w.childNodes), w.childNodes), E[w.childNodes.length].nodeType;
} catch (t) {
$ = {
...
for (l = y.length; l--; ) (f = y[l]) && -1 < (c = o ? q(i, f) : p[l]) && (i[c] = !(a[c] = f));
}
...
var n, o, i, s, u, l, f = [], h = [], m = M[e + " "];
if (!m) {
for (t || (t = a(e)), n = t.length; n--; ) (m = Te(t[n]))[x] ? f.push(m) : h.push(m);
(m = M(e, (o = h, s = 0 < (i = f).length, u = 0 < o.length, l = function(e, t, n, a, l) {
var f, h, m, y = 0, v = "0", b = e && [], x = [], w = c, j = e || u && r.find.TAG("*", l), T = _ += null == w ? 1 : Math.random() || .1, C = j.length;
for (l && (c = t === d || t || l); v !== C && null != (f = j[v]); v++) {
if (u && f) {
...
$.apply(a, x), l && !e && 0 < x.length && 1 < y + i.length && se.uniqueSort(a);
}
return l && (_ = T, c = w), b;
}, s ? ce(l) : l))).selector = e;
}
...
}, n.sortStable = x.split("").sort(k).join("") === x, n.detectDuplicates = !!f, 
...
}), C.ready.then = z.then, "complete" === s.readyState || "loading" !== s.readyState && !s.documentElement.doScroll ? n.setTimeout(C.ready) : (s.addEventListener("DOMContentLoaded", U), 
...
for (var i, a, s, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((i = e[d]) || 0 === i) if ("object" === j(i)) C.merge(p, i.nodeType ? [ i ] : i); else if (Te.test(i)) {
...
var Me = /^key/, Ae = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ke = /^([^.]*)(?:\.(.+)|)/;
function Se() {
return !0;
}
function Ee() {
...
})) : void 0 === ee.get(e, t) && C.event.add(e, t, Se);
}
C.event = {
global: {},
...
}), c = (t = (t || "").match(P) || [ "" ]).length; c--; ) d = g = (s = ke.exec(t[c]) || [])[1], 
...
if (m && (u = m.events)) {
for (c = (t = (t || "").match(P) || [ "" ]).length; c--; ) if (d = g = (s = ke.exec(t[c]) || [])[1], 
h = (s[2] || "").split(".").sort(), d) {
...
setup: function(e) {
var t = this || e;
return me.test(t.type) && t.click && D(t, "input") && $e(t, "click", Se), !1;
},
trigger: function(e) {
var t = this || e;
return me.test(t.type) && t.click && D(t, "input") && $e(t, "click"), !0;
},
_default: function(e) {
var t = e.target;
...
e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Se : Ee, 
...
which: function(e) {
var t = e.button;
return null == e.which && Me.test(e.type) ? null != e.charCode ? e.charCode : e.keyCode : !e.which && void 0 !== t && Ae.test(e.type) ? 1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0 : e.which;
}
...
var Oe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, qe = /<script|<style|<link/i, Le = /checked\s*(?:[^=]|=\s*.checked.)/i, Ge = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
function Re(e, t) {
...
if (s) for (c = a[a.length - 1].ownerDocument, C.map(a, Pe), f = 0; f < s; f++) u = a[f], 
...
if ("string" == typeof e && !qe.test(e) && !be[(ye.exec(e) || [ "", "" ])[1].toLowerCase()]) {
e = C.htmlPrefilter(e);
try {
...
var Fe = new RegExp("^(" + ie + ")(?!px)[a-z%]+$", "i"), ze = function(e) {
var t = e.ownerDocument.defaultView;
return t && t.opener || (t = n), t.getComputedStyle(e);
}, Ue = new RegExp(se.join("|"), "i");
function Qe(e, t, n) {
var r, o, i, a, s = e.style;
return (n = n || ze(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ce(e) || (a = C.style(e, t)), 
...
function it(e, t, n) {
var r = ze(e), o = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r), i = o, a = Qe(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
if (Fe.test(a)) {
if (!n) return a;
a = "auto";
}
...
set: function(e, n, r) {
var o, i = ze(e), a = !v.scrollboxSize() && "absolute" === i.position, s = (a || r) && "border-box" === C.css(e, "boxSizing", !1, i), u = r ? ot(e, t, r, s, i) : 0;
...
var Mt = /^(?:focusinfocus|focusoutblur)$/, At = function(e) {
e.stopPropagation();
};
C.extend(C.event, {
...
if (!o && !p.noBubble && !x(r)) {
for (c = p.delegateType || m, Mt.test(c + m) || (a = a.parentNode); a; a = a.parentNode) h.push(a), 
u = a;
...
var kt = n.location, St = Date.now(), Et = /\?/;
...
}); else if (n || "object" !== j(t)) r(e, t); else for (o in t) qt(e + "[" + o + "]", t[o], n, r);
}
...
var e = this.type;
return this.name && !C(this).is(":disabled") && Ot.test(this.nodeName) && !$t.test(e) && (this.checked || !me.test(e));
}).map(function(e, t) {
var n = C(this).val();
...
var Lt = /%20/g, Gt = /#.*$/, Rt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, Pt = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Bt = {}, Ft = "*/".concat("*"), zt = s.createElement("a");
function Ut(e) {
return function(t, n) {
...
if (y.promise(j), h.url = ((e || h.url || kt.href) + "").replace(It, kt.protocol + "//"), 
...
delete h.data), !1 === h.cache && (o = o.replace(Rt, "$1"), d = (Et.test(o) ? "&" : "?") + "_=" + St++ + d), 
...
if (_ = "abort", v.add(h.complete), j.done(h.success), j.fail(h.error), r = Qt(Bt, h, t, j)) {
...
function T(e, t, a, s) {
var c, p, d, x, w, _ = t;
l || (l = !0, u && n.clearTimeout(u), r = void 0, i = s || "", j.readyState = 0 < e ? 4 : 0, 
...
}(h, x, j, c), c ? (h.ifModified && ((w = j.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w), 
...
s ? e[s] = e[s].replace(Zt, "$1" + o) : !1 !== e.jsonp && (e.url += (Et.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), 
...
t.head.appendChild(r)) : t = s), i = !n && [], (o = $.exec(e)) ? [ t.createElement(o[1]) ] : (o = Ce([ e ], t, i), 
...
var r = {
"./shimo-im-discuz/": 2,
"./shimo-im-discuz/base/shimo-im-discuz": 4,
"./shimo-im-discuz/base/shimo-im-discuz.js": 4,
"./shimo-im-discuz/index": 2,
"./shimo-im-discuz/index.js": 2,
"./shimo-im-discuz/index.user": 3,
"./shimo-im-discuz/index.user.js": 3,
"./shimo-im-discuz/lib/metadata": 9,
"./shimo-im-discuz/lib/metadata.js": 9
};
function o(e) {
var t = i(e);
return n(t);
...
var S = "*" === T.type ? u : "?" === T.type ? s : "\\" + T.type;
i = !0, r = r.slice(0, T.reStart) + S + "\\(" + k;
}
b(), c && (r += "\\\\");
var E = !1;
switch (r.charAt(0)) {
...
var D = p[N], $ = r.slice(0, D.reStart), O = r.slice(D.reStart, D.reEnd - 8), q = r.slice(D.reEnd - 8, D.reEnd), L = r.slice(D.reEnd);
q += L;
...
if ("" !== r && i && (r = "(?=.)" + r), E && (r = y + r), t === w) return [ r, i ];
if (!i) return C(e);
var I = n.nocase ? "i" : "";
try {
...
var k = p.some(y);
w = [];
for (var S = _; M(S, j); S += C) {
var E;
if (u) "\\" === (E = String.fromCharCode(S)) && (E = ""); else if (E = String(S), 
k) {
var N = T - E.length;
if (N > 0) {
var D = new Array(N + 1).join("0");
E = S < 0 ? "-" + D + E.slice(1) : D + E;
}
}
w.push(E);
}
...
var r = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", o = /^([\-+])=\s*(\d+\.?\d*)/, i = [ {
...
}, c = a.support = {}, l = e("<p>")[0], f, p = {}, d = e.each;
function h(e, t, n) {
var r = u[t.type] || {};
...
function g(t) {
var n = a(), r = n._rgba = [];
return t = t.toLowerCase(), d(i, function(e, o) {
var i, a = o.re.exec(t), u = a && o.parse(a), c = o.space || "rgba";
if (u) return i = n[c](u), n[s[c].cache] = i[s[c].cache], r = n._rgba = i._rgba, 
!1;
}), r.length ? ("0,0,0,0" === r.join() && e.extend(r, f.transparent), n) : f[t];
}
...
_cache_: {},
parse: function(t, r, o, i) {
if (this._data_ = this._data_ || {}, t === n) return this._rgba = [ null, null, null, null ], 
this;
(t.jquery || t.nodeType) && (t = e(t).css(r), r = n);
var u = this, c = e.type(t), l = this._rgba = [], p;
if (p = u._data_.spaceName = "rgba", r !== n && ("array" === c || "object" === c) && r in s && (p = u._data_.spaceName = r + "", 
r = n, delete r, !0 !== o)) {
var m = {};
return "array" === c ? d(s[p].props, function(e, n) {
m[e] = h(t[n.idx], n);
}) : "object" === c && d(s[p].props, function(e, n) {
m[e] = h(t[e], n);
}), u.parse(m, p, !0);
}
if (r !== n && (t = [ t, r, o, i ], c = "array"), "string" === c) return this.parse(g(t) || f._default);
if ("array" === c) return d(s.rgba.props, function(e, n) {
l[n.idx] = h(t[n.idx], n);
}), this;
if ("object" === c) {
if (t instanceof a) u.copy(t); else {
var v = {};
y._each(function(e, r) {
var o = r.cache;
v[o] = 0, d(r.props, function(e, r) {
t[e] !== n && v[o]++;
}), v._ = Math.max(v._ || 0, v[o]);
}), y._each(function(n, r) {
var o = r.cache;
"rgba" != n && (v._ > v[o] || !v[o]) || ("rgba" != n && v._++, p = u._data_.spaceName = n + "", 
...
is: function(e, t) {
var n = a(e), r = !0, o = this;
return t && (n = n.toVaild(), t > 1 && (o = o.toVaild())), y._each(function(e, t) {
var i, a = n[t.cache];
return a && (i = o[t.cache] || t.to && t.to(o._rgba) || [], d(t.props, function(e, t) {
if (null != a[t.idx]) return r = a[t.idx] === i[t.idx];
})), r;
}), r;
},
_space: function() {
var e = [], t = this;
return y._each(function(n, r) {
t[r.cache] && e.push(n);
}), e.pop();
},
spaceName: function() {
...
var n = a(e), r = n._space(), o = s[r], i = 0 === this.alpha() ? a("transparent") : this, c = i[o.cache] || o.to(i._rgba), l = c.slice();
return n = n[o.cache], d(o.props, function(e, r) {
var o = r.idx, i = c[o], a = n[o], s = u[r.type] || {};
null !== a && (null === i ? l[o] = a : (s.mod && (a - i > s.mod / 2 ? i += s.mod : i - a > s.mod / 2 && (i -= s.mod)), 
l[o] = h((a - i) * t + i, r)));
}), this[r](l);
},
blend: function(t) {
if (1 === this._rgba[3]) return this;
var n = this._rgba.slice(), r = n.pop(), o = a(t)._rgba;
...
if (t && "rgba" != t) return this["to" + b(t) + "String"]();
}
...
invert: function(e) {
var t = this._rgba.slice(), n, r;
for (e && (t = this.clone().blend()._rgba.slice()), r = 0; r < 3; r++) t[r] = Math.abs(255 - t[r]);
return a(t);
},
...
exec: function(e) {
var t = Array.prototype.slice.call(arguments, 1) || [], r = e.apply(this, t);
return r === n ? this : r;
},
blendBrightness: function(t, n) {
var r = this._rgba.slice(), o = r.pop();
if (n) {
var i = this.clone().blend();
o = (r = i._rgba.slice()).pop();
}
var s = r.slice().sort(function(e, t) {
return t - e;
})[0], u = s;
...
rand: function(t) {
var n = this._rgba.slice(), r;
for (e.isFunction(t) || (t = Math.random), r = 0; r < 3; r++) n[r] = Math.round(t(r, n[r]) * (1 + n[r]));
return a(n);
},
scale: function(t) {
var n = this._rgba.slice(), r;
return e.isArray(t) || (t = [ t, t, t, 1 ]), n.map(function(e, r) {
n[r] = Math.round(t[r] * e);
}), a(n);
},
contrastColor: function() {
var e = this._rgba[0], t = this._rgba[1], n = this._rgba[2];
return a((299 * e + 587 * t + 144 * n) / 1e3 >= 131.5 ? "black" : "white");
},
...
format: function(t) {
if (t === n) return this._data_.format || a.options.format;
var r = this, o;
...
copy: function(t) {
var n = this;
return n._data_ = e.extend({}, t._data_, {}), d(s, function(e, r) {
delete n[r.cache], t[r.cache] && (n[r.cache] = t[r.cache].slice());
}), n._update(), n;
},
toVaild: function(e) {
var t = this, n;
return this.isVaild() ? n = e ? this : a(this) : (n = a(this.toString(2)), e && (n = this.copy(n))), 
n;
}
}), a.fn.parse.prototype = a.fn;
try {
Object.defineProperty(a, "_cache_", {
value: p,
writable: !1,
enumerable: !1,
configurable: !1
...
var r, o, i;
if (e /= 360, 0 == t) {
var a = Math.round(255 * n);
return [ a, a, a ];
}
var s = 6 * e, u = Math.floor(s), c = n * (1 - t), l = n * (1 - t * (s - u)), f = n * (1 - t * (1 - (s - u)));
return 0 == u ? (r = n, o = f, i = c) : 1 == u ? (r = l, o = n, i = c) : 2 == u ? (r = c, 
o = n, i = f) : 3 == u ? (r = c, o = l, i = n) : 4 == u ? (r = f, o = c, i = n) : (r = n, 
o = c, i = l), [ r = Math.round(255 * r), o = Math.round(255 * o), i = Math.round(255 * i) ];
},
rgb2hsv: function(e, t, n) {
var r = Math.min(e, t, n), o = Math.max(e, t, n), i = o - r, a, s, u = o;
if (u = Math.floor(o / 255 * 100), 0 == o) return [ 0, 0, 0 ];
s = Math.floor(i / o * 100);
var c = 0 == i ? 1 : i;
return a = e == o ? (t - n) / c : t == o ? 2 + (n - e) / c : 4 + (e - t) / c, (a = Math.floor(60 * a)) < 0 && (a += 360), 
[ a, s / 100, u / 100 ];
}
}), s.hsla.to = function(e) {
if (null == e[0] || null == e[1] || null == e[2]) return [ null, null, null, e[3] ];
var t = e[0] / 255, n = e[1] / 255, r = e[2] / 255, o = e[3], i = Math.max(t, n, r), a = Math.min(t, n, r), s = i - a, u = i + a, c = .5 * u, l, f;
return l = a === i ? 0 : t === i ? 60 * (n - r) / s + 360 : n === i ? 60 * (r - t) / s + 120 : 60 * (t - n) / s + 240, 
f = 0 === s ? 0 : c <= .5 ? s / u : s / (2 - u), [ Math.round(l) % 360, f, c, null == o ? 1 : o ];
}, s.hsla.from = function(e) {
if (null == e[0] || null == e[1] || null == e[2]) return [ null, null, null, e[3] ];
var t = e[0] / 360, n = e[1], r = e[2], o = e[3], i = r <= .5 ? r * (1 + n) : r + n - r * n, s = 2 * r - i;
return [ Math.round(255 * a.hue2rgb(s, i, t + 1 / 3)), Math.round(255 * a.hue2rgb(s, i, t)), Math.round(255 * a.hue2rgb(s, i, t - 1 / 3)), o ];
}, s.hsla.fromto = e.extend(s.hsla.fromto, {}, {
hsva: function(e) {
return m(e) ? [ e[0], e[1], null, e[3] ] : a.hsv2hsl.apply(a, e);
}
}), s.hsva.to = function(e) {
var t;
if (t = m(e)) return t;
var n = e[3], r = a.rgb2hsv(e[0], e[1], e[2]);
return r[3] = null == n ? 1 : n, r;
}, s.hsva.from = function(e) {
var t;
if (t = m(e)) return t;
var n = e[0], r = e[1], o = e[2], i = e[3], s = a.hsv2rgb(n, r, o);
return s[3] = null == i ? 1 : i, s;
}, s.hsva.fromto = e.extend(s.hsva.fromto, {}, {
hsla: function(e) {
return m(e) ? [ e[0], e[1], null, e[3] ] : a.hsl2hsv.apply(a, e);
}
});
var y = [];
function v(e) {
...
return y.__proto__._each = function(e) {
return this.forEach(function(t, n, r) {
return e(t.name, t);
});
}, d(s, function(e, t) {
t.name = e, y.push(s[e]);
...
}), p["spaces.order"] = y, y._each(function(e, t) {
var n = t.props;
d(n, function(t, n) {
a._.props[t] = a._.props[t] || {}, a._.props[t][e] = n.idx;
});
}), y._each(function(t, r) {
var i = r.props, u = r.cache, c = r.to, l = r.from;
a.fn[t] = function(t) {
if (c && !this[u] && (this[u] = c(this._rgba)), t === n) return this[u].slice();
var r, o = e.type(t), s = "array" === o || "object" === o ? t : arguments, f = this[u].slice();
return d(i, function(e, t) {
var n = s["object" === o ? e : t.idx];
null == n && (n = f[t.idx]), f[t.idx] = h(n, t);
}), l ? ((r = a(l(f)))[u] = f, r) : a(f);
}, d(i, function(n, r) {
a.fn[n] || (a.fn[n] = function(i) {
var u = this, c, l, f, p, h, g;
l = u._space(), d(a._.props[n], function(e) {
var t = s[e].cache;
u[t] && (f = c, c = e, g = s[e].props[n]);
}), g = g || r, c = c || t;
var m = e.type(i), y;
return h = c != l && s[c].fromto && s[c].fromto[l] ? (p = s[c].fromto[l](this[l]()))[g.idx] : (p = this[c]())[g.idx], 
"undefined" === m ? h : ("function" === m && (i = i.call(this, h), m = e.type(i)), 
null == i && g.empty ? this : ("string" === m && (y = o.exec(i)) && (i = h + parseFloat(y[2]) * ("+" === y[1] ? 1 : -1)), 
p[g.idx] = i, this[c](p)));
});
});
}), a.hook = function(t) {
...
set: function(t, r) {
var o, i, s = "";
if ("transparent" !== r && ("string" !== e.type(r) || (o = g(r)))) {
if (r = a(o || r), !c.rgba && 1 !== r._rgba[3]) {
...
}, a.hook(r), e.cssHooks.borderColor = {
expand: function(e) {
var t = {};
